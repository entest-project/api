...
class DeleteOrganizationIssueTrackerConfigurationVoter extends Voter
{
    ...
    {
        return $attribute === Verb::DELETE && $subject instanceof OrganizationIssueTrackerConfiguration;
    }
